# Generated by Django 4.1 on 2023-11-20 06:08
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('base', '0011_floodhazardinfo'),
    ]

    operations = [
        migrations.CreateModel(
            name='FloodReportPerBarangay',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('municipality_name', models.CharField(blank=True, max_length=255, null=True)),

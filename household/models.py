...
class Households(models.Model):
  ...
  year_flooded = models.IntegerField(validators=[MinValueValidator(1940), max_value_current_year],default=current_year())
  experience_evacuate = models.BooleanField(_('Experience evacuation during calamity'))
  year_evacuate = models.IntegerField(validators=[MinValueValidator(1940), max_value_current_year],default=current_year())
